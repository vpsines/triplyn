                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <figure className="flex items-center gap-1">
                            ...
                            <figcaption className={cn("text-sm font-medium",isDecrement?'text-red-500':'text-green-700')}>{Math.round(percentage)}%</figcaption>
                        </figure>
                        <p className="text-sm font-medium text-gray-100 truncate">vs last month</p>
                    </div>
                </div>
                <img src={`/assets/icons/${isDecrement? 'decrement.svg':
                'increment.svg'}`} alt='trend-graph' className="xl:w-32 w-full h-full md:h-32 xl:h-full" />
            </div>
        </article>
    )
}
