...
const TripDetail = ({loaderData}:Route.ComponentProps) => {
    ...
    const pillItems = [
        ...
        { text: interests, bg:'!bg-navy-50 !text-pink-500'}
    ]
    ...
    return (
        <main className="travel-detail wrapper">
            ...
            <section className="container wrapper-md">
                ...
                <section className="gallery">
                    {
                        imageUrls.map((url:string,index:number)=>(
                            <img src={url} key={index} className={cn('w-full rounded-xl object-cover',
                            index ===0 ? 'md:col-span-2 md:row-span-2 h-[330px]'
                ...
                {
                    visitTimeAndWetherInfo.map((section)=>(
